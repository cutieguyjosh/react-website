		...
		<React.Fragment>
			...
			<Container className="container-projects">
				<div className="first-card">
					<img className="project1-pic" alt="project1" src={project1} />
				...
				<div className="second-card">
					<img className="project2-pic" alt="project2" src={project2} />
				...
				<div className="third-card">
					<img className="project3-pic" alt="project3" src={project3} />
